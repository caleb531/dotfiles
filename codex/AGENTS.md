...
- Add thoughtful code comments to any new code that you've written; in addition, every function, variable, and definition in new code you've written should have a header comment
